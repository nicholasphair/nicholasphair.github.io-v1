...
title: Personal Homepage of Nick
...
I'll publish it in the hopes that someone else finds it useful. If not, that's
okay too. Having my notes here will allow me to go back at anytime and easily
review.

[//]: # (Maximum four posts on front page where first two posts are featured, and remaining are date sorted.)
[//]: # (What follows is the code to make that happen)
